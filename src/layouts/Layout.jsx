...
export const Layout = () => {
  ...
  return (
    <>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              <a href="/" class="flex ms-2 md:me-24">
                <img src="https://nexpando.com/assets/logo" class="h-8 me-3" />
            ...
            <div class="flex items-center">
              <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
                <button
                  type="button"
                  className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 w-8 h-8"
                  id="user-menu-button"
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Blockly</span>
              </a>
            </li>
            <li>
              <a
                href="/collectionManagement"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      <div class="p-5 ml-[256px] mt-[56px]">
        <Outlet />
      </div>
    </>
  );
